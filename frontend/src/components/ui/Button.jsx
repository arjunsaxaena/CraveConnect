...
const Button = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-secondary-600 hover:bg-secondary-700 text-white disabled:bg-secondary-300',
    outline: 'border border-gray-300 hover:bg-gray-100 text-gray-700 disabled:bg-gray-100 disabled:text-gray-400',
